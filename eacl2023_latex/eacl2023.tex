...
In this study, we present computational text analysis on relatively understudied topic of
how Asian workers are represented in the historical newspapers in the United States. We found that the word ``coolie'' 
was semantically different in some States (e.g., Massachusetts, Rhode Island, Wyoming, Oklahoma, and Arkansas)
with different discourse around coolie. We also found then-Confederate newspapers and then-Union newspapers
formed distinctive discourse by measuring over-represented words. Newspapers from then-Confederate States
associated coolie with slavery-related words. In addition, we found Asians were perceived to be 
inferior to European immigrants and subjected to the target of racism. This study contributes to supplement
the qualitative analysis on racism in the United States with quantitative discourse analysis.  
...
\url{https://github.com/available-upon-acceptance}.
...
\citet{bamman2014bayesian} studied the origin of the word ``coolie''
...
Pennsylvania, New Jersey, Ohio, Indiana, Illinois, Kansas, Michigan, Minnesota, Wisconsin, Iowa, California, Nevada, Oregon,
...
\begin{table}[h!]
  ...
  \begin{figure*}[h!]
    \centering
    \includegraphics[width=0.65\textwidth]{figure/z-score-token-union-confederate.pdf}
...
were well-captured by log-odds ratio metric. For instance, ``plantation'' (Z-score=-2.023) and 
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\columnwidth]{figure/excerpt1.png}
  \caption{The text containing ``coolie'' in \textit{The Opelousas courier} published in July 8th, 1876}
  \label{fig:excerpt1}
\end{figure}
...
%Micro aggression: Racism is so naturalized. Which it might be offensive to people totally normalized racism: mainstream perpetrated many people would not recognize this as racism. Many information spreads out even in this modern era: Russia v. Ukraine. This poem is totally Edward Said (orientalism: has idea of Asia as exotic: but also racist) Timbucktoo: a city in Africa (Mali): in a lot of Western text it was used as the other side of the world (Far away to oriental) Chinese person in Timbucktoo is to express the exotic thing. Sound distant. ``That's Greek to me.''= I cannot relate at all. Written in the finest Greek shows it 
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.70\columnwidth]{figure/excerpt2.png}
  \caption{The text containing ``coolie'' in \textit{Middletown transcript} published in April 13th, 1918}
  \label{fig:excerpt2}
\end{figure}
...
and ``jews'' even though they are not necessarily critical components that
make rhymes work. 
\textbf{Any examples that used marginalized people in the poem?}
