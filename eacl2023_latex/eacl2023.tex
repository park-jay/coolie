...
We represented the Capital city of each State instead of connecting the cities where the newspapers were printed.
...
Another comparison can be made with treating Asian workers as a commodity instead of
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.65\columnwidth]{figure/excerpt2.png}
